...
public class LoginValues {
	...
	private String token = ConstantKeys.STRING_DEFAULT;
	private UserReadResponse user = null;
	...
	public UserReadResponse getUser() {
		return user;
	}
	...
	public void setUser(UserReadResponse user) {
		this.user = user;
	}
}
